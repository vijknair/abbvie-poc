...
# ---------------------------------------------------------------------------
# Usage: ./da-upload.sh <site-name> <content-folder>
#   e.g. ./da-upload.sh ozurdex-da content/ozurdex
#        ./da-upload.sh rinvoq-da content/rinvoq
#
...
# ---------------------------------------------------------------------------
if [ -z "$1" ] || [ -z "$2" ]; then
  echo "Usage: $0 <site-name> <content-folder>"
  echo "  e.g. $0 ozurdex-da content/ozurdex"
  echo "       $0 rinvoq-da content/rinvoq"
  exit 1
fi
...
OUTPUT_DIR="$SCRIPT_DIR/docs/$SITE_NAME"
...
data = {
    "assets": sorted(urls),
    "siteOrigin": "https://www.ozurdex.com"
}
